[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32f30x-cmake-vscode)](https://github.com/burakenez/gd32f30x-cmake-vscode/tags/)

# GD32F30x Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32F30x Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32F30x Demo Suites V3.0.3](https://www.gd32mcu.com/en/download)_** and **_[GD32F30x Firmware Library V3.0.3](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32f30x-cmake-vscode.git
```
...
- **Source:** `GD32F30x Demo Suites V3.0.3`

### 3. **GD32F30x_usbfs_library**
- **Version:** ``
- **Path:** `Drivers/GD32F30x_usbfs_library`
- **Source:** `GD32F30x Demo Suites V3.0.3`

### 4. **GD32F30x_standard_peripheral**
- **Version:** `None`
- **Path:** `Drivers/GD32F30x_standard_peripheral`
- **Source:** `GD32F30x Demo Suites V3.0.3`

### 5. **GD32F30x_usbd_library**
- **Version:** ``
